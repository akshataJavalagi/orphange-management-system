...
<a href="user-requests.php?uid=<?php echo htmlentities($row->Userid);?>&&uname=<?php echo htmlentities($row->FullName);?>" target="blank">
<button type="button" class="btn btn-primary">Adoption Requests</button></a>
</td>
</tr>
        <?php $cnt++;
    }} ?>                         
