...
<head>
    ...
    <title>Orphanage Management System | New Adoption Requset</title>
...
<?php include_once('includes/leftbar.php');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> New Adoption Request</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
<?php
$sql = "SELECT tbladoption.ID as aid,tbladoption.Userid,tbladoption.Childid,tbladoption.Requestnumber,tblusers.FullName,tblusers.Emailid,tblusers.PhoneNumber,tbladoption.Status,tbladoption.RequsetDate from tbladoption left  join tblusers on tblusers.Userid=tbladoption.Userid where tbladoption.Status is null";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
